...
<>
    ...
    <div className='details-container'>
      ...
      <div className='action-card'>+ add to list</div>
        ...
        <div className='left'>
          <div className='heading'>Sunrise and Sunset</div>
           <div className='sun-info'>
             <div>Length of the day : <strong>xxx</strong></div>
             <div>Remaining Daylight : <strong>xxx</strong></div>
           </div>
        </div>
        <div className='right'>
